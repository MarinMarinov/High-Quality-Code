namespace Task01.School.Tests
{
    ...
    public class CourseTests
    {
        ...
        public void TestCourseListToRemoveTheCorrectStudent()
        {
            ...
            Assert.IsFalse(testCourse.StudentList.Contains(testStudent), "Student must have been removed");
            Assert.AreEqual(expectedStudentCount, testCourse.StudentList.Count, "The count of the students in course are not equal to student number");
        }
